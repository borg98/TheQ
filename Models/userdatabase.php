...
class UserDatabase
{
  ...
  function insertUserDetails($userId, $firstname, $lastname, $address, $city, $zip, $phone)
  {
    $sql = "insert into usersdetails (user_id, firstname, lastname, address, city, zip, phone) values (:user_id, :firstname, :lastname, :address, :city, :zip, :phone)";
    $stmt = $this->pdo->prepare($sql);
    $stmt->execute(['user_id' => $userId, 'firstname' => $firstname, 'lastname' => $lastname, 'address' => $address, 'city' => $city, 'zip' => $zip, 'phone' => $phone]);
  }
